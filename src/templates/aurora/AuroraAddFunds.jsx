// src/templates/aurora/AuroraAddFunds.jsx
...
export default function AuroraAddFunds() {
  ...
  return (
    <AuroraLayout>
      <div className="max-w-lg mx-auto space-y-5 pt-2">
        ...
        >
          <div>
            <h1 className="text-xl font-black text-white">Add Funds</h1>
            <p className="text-xs mt-1" style={{ color: "rgba(255,255,255,0.4)" }}>Select a payment method and deposit amount.</p>
          </div>
        ...
        >
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-sm font-bold text-white">Having trouble with a payment?</p>
