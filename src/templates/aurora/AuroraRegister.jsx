// src/templates/aurora/AuroraRegister.jsx
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full opacity-20 blur-3xl" style={{ background: brand.color }} />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full opacity-10 blur-3xl" style={{ background: "#6366f1" }} />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        >
          ...
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-bold text-white">Join {brand.name}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              <FiMail size={15} className="absolute left-4 top-3.5" style={{ color: "rgba(255,255,255,0.35)" }} />
              <input
                type="email"
                value={email}
            ...
            <div>
              <PhoneInput
                ...
                dropdownStyle={{ background: "#1e1b3a", color: "#e2e8f0" }}
              />
            </div>

            {/* Password */}
            <div className="relative">
              <FiLock size={15} className="absolute left-4 top-3.5" style={{ color: "rgba(255,255,255,0.35)" }} />
              <input
                ...
                onBlur={(e) => (e.target.style.borderColor = "rgba(255,255,255,0.1)")}
              />
              <button type="button" onClick={() => setShowPw((s) => !s)} className="absolute right-4 top-3.5" style={{ color: "rgba(255,255,255,0.35)" }}>
            ...
            <div className="relative">
              ...
              <input
                ...
                onBlur={(e) => (e.target.style.borderColor = "rgba(255,255,255,0.1)")}
              />
              <button type="button" onClick={() => setShowConfirm((s) => !s)} className="absolute right-4 top-3.5" style={{ color: "rgba(255,255,255,0.35)" }}>
          ...
          <p className="text-center text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>
            ...
            <Link to="/login" className="font-semibold hover:underline" style={{ color: brand.color }}>
              Sign in
            </Link>
          </p>
        </div>
