      ...
      >
        ...
        >
          ...
          {[...Array(2)].map((_, i) => (
            <div
              key={i}
              className="h-12 bg-white/10 rounded-xl mb-3"
            />
          ))}
      ...
      <div className="flex-1 flex items-start justify-center px-4 pb-12">
        ...
        >
          ...
          >
            {/* Email */}
            <div>
              <label className="block text-white/65 text-xs font-semibold mb-1">
                Email Address
              </label>
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-6">
            {[
              ...
              <span
                key={item}
                className="text-xs bg-white/10 text-white/65 px-3 py-1 rounded-full"
              >
                {item}
              </span>
            ))}
