...
<div className="bg-white shadow-lg hover:shadow-xl transition rounded-lg p-5 border-l-4 border-blue-500">
...
<FiShoppingCart className="text-blue-400 text-3xl" />
...
<div className="bg-white shadow-lg hover:shadow-xl transition rounded-lg p-5 border-l-4 border-green-500">
...
<div className="bg-white shadow-lg hover:shadow-xl transition rounded-lg p-5 border-l-4 border-purple-500">
