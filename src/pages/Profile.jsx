...
const Profile = () => {
  ...
  const handleRevokeKey = async () => {
    ...
    try {
      ...
      setProfile((prev) => ({ ...prev, apiKey: null, apiAccessEnabled: false }));
      setShowKey(false);
    ...
    <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      <main className="flex-grow max-w-3xl mx-auto mt-8 px-4 w-full">
        <div className="bg-white rounded-2xl shadow-lg p-6 pb-10 space-y-6">
          ...
          {/* ── Edit Profile Actions — only Cancel since fields are readonly ── */}
          {editMode && (
          ...
          {/* ── API Access Section — hidden for reseller end users ── */}
          {!isResellerEndUser && (
            <>
              <hr />
