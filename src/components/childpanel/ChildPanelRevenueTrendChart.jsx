// src/components/childpanel/ChildPanelRevenueTrendChart.jsx
...
const ChildPanelRevenueTrendChart = () => {
  ...
  const fetchTrend = useCallback(async () => {
    setLoading(true);
    try {
      const { data } = await API.get("/child-panel/revenue-trend", {
        params: { range },
      });
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
      ...
      <div className="h-72">
        {loading ? (
          ...
          >
            <defs>
              <linearGradient id="cpRevenueFill" x1="0" y1="0" x2="0" y2="1">
            ...
            <path d={areaPath} fill="url(#cpRevenueFill)" stroke="none" />
...
export default ChildPanelRevenueTrendChart;
