// src/components/childpanel/ChildPanelTopPerformers.jsx
...
const ChildPanelTopPerformers = ({ dateRange = "30days" }) => {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const res = await API.get("/child-panel/top-performers", {
        params: { dateRange },
      });
      setData({
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">
            Best performing platforms, categories &amp; services on your panel
          </p>
        </div>
...
export default ChildPanelTopPerformers;
