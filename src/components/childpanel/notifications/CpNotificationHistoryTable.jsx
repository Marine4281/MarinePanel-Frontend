// src/components/childpanel/notifications/CpNotificationHistoryTable.jsx
const AUDIENCE_LABELS = {
  own: "My Own Users",
  resellerEndUsers: "My Resellers' End Users",
  both: "Everyone On My Panel",
};

const CpNotificationHistoryTable = ({ notifications, onEdit, onDelete }) => {
        ...
        <tbody>
          {notifications.map((n) => (
            <tr key={n._id} className="border-t">
              ...
              <td className="px-4 py-2">{AUDIENCE_LABELS[n.cpAudience] || n.cpAudience}</td>
              ...
              <td className="px-4 py-2 text-right space-x-2">
                <button onClick={() => onEdit(n)} className="text-blue-600 hover:underline">Edit</button>
...
export default CpNotificationHistoryTable;
