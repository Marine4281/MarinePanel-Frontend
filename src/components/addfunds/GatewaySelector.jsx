...
const GatewaySelector = ({ gateways, selected, onSelect, loading }) => (
  <div>
    ...
    {loading ? (
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex flex-col items-center gap-2 p-4 rounded-xl border-2 border-gray-100 animate-pulse">
